...
export const EditModal = ({
  ...
  return (
    <Modal show={show} onHide={() => setShowEditModal(false)}>
      ...
      <Modal.Body>
        <Form autoComplete="off">
          <Form.Group className="mb-3" controlId="formName">
            ...
            <Form.Control
              value={newEventObject.description}
              name="description"
          ...
          <Form.Group className="mb-3" controlId="formName">
            ...
            <Form.Control
              value={newEventObject.featureFlag || ""}
              name="featureFlag"
              onChange={(e) => handleChange(e)}
      ...
      <Modal.Footer>
        <Button id="primary_btn" onClick={() => updateEvent(newEventObject)}>
          Update
        </Button>
        <Button className="btn btn-danger" onClick={() => deleteEvent(event)}>
          Delete
        </Button>
      </Modal.Footer>
    </Modal>
